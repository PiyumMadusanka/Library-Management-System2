...
public class EnterBookIssue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        com_student = new javax.swing.JComboBox<>();
        ...
        com_student.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        getContentPane().add(com_student);
        com_student.setBounds(300, 150, 310, 30);
        ...
        lbl_heading.setText("Book Issue");
...
//        }
    ...
    private void getAllUsersForCombo() {
        USER_LIST = DATABASE_CON.getAlUsersForIssueBook();
        USER_LIST.forEach((uname, id) -> {
            com_student.addItem(uname);
        });
    }

    private void validateTheBookBeforeIssue() {
        ...
        if (!txt_code.getText().trim().equals("")) {
            ...
            if (!SELECTED_BOOK_NAME.equals("")) {
                ...
                if (DATABASE_CON.isThisAvailbeForIssue(SELECTED_BOOk_CODE)) {
                    lbl_book_status.setForeground(Color.BLUE);
                    lbl_book_status.setText("Selected book is available for issue!");
                } else {
                    lbl_book_status.setForeground(Color.RED);
                    lbl_book_status.setText("Selected book is already issued!");
                }
            } else {
                lbl_book_status.setForeground(Color.RED);
    ...
    private void saveBookIssueData() {
        if (!SELECTED_BOOk_CODE.equals("") && !SELECTED_BOOK_NAME.equals("")) {
            if (date_return_date.getDate() != null && !date_return_date.getDate().toString().equals("")) {
                if (DATABASE_CON.saveIssueBookDataToDb(SELECTED_BOOk_CODE, USER_LIST.get(com_student.getSelectedItem().toString()), dateFormat.format(date_return_date.getDate()), txta_remarks.getText().trim())) {
                    clearFeilds();
                    JOptionPane.showMessageDialog(null, "Book issue is success!", "SUCCESS", 1);
                } else {
                    JOptionPane.showMessageDialog(null, "Something went wrong. Please try again!", "ERROR", 2);
                }
            } else {
    ...
    private void clearFeilds() {
        ...
        com_student.setSelectedIndex(0);
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btn_add;
    private javax.swing.JButton btn_clear;
    private javax.swing.JComboBox<String> com_student;
